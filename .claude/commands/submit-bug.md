...
1. **Pin down the symptom**. Don't just say "it's broken" — describe **what page / endpoint / flow** and **what you saw vs. what you expected**. If you have screenshots or HAR captures, mention them (filesystem paths are fine; the receivers can read them).
...
7. Report back the bug id, the recipients, and remind the user:
   - 每个收件人 `/pickup` 后会看到归属判断决策树(修 / reassign / 协商)
