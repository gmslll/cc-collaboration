...
Sender flow:
  ...
  cc-handoff capsule      submit --source-agent claude|codex [--public] [--org-id ID] [--project-id ID] [--transcript F] [--transcript-text F] [--persona F] [--seed F] [--origin-session ID] [--summary TEXT]
