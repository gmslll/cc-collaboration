...
// repo or user agent home (slash commands, Codex skills, launchd plist,
// systemd unit). The package never
...
// CommandFiles enumerates the workflow prompt files in copy order. The list is
// the source of truth for which files init copies into .claude/commands/ and
