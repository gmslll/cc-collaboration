...
class Cli {
  ...
  // todoImportLinear runs `cc-handoff todo import-linear`. When no
  // workingDirectory is supplied, the CLI resolves user-level config only;
  // teamKey/linearProjectId must be provided by the caller.
